...
Color backgroundColor = Color.fromRGBO(64, 30, 7, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(64, 30, 7, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(64, 30, 7, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(64, 30, 7, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(112, 59, 21, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(112, 59, 21, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(112, 59, 21, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(64, 30, 7, 1.0);
Color iconTextColor = Colors.white;
Color buttonColor = Color.fromRGBO(112, 59, 21, 1.0);
Color textColor = Color.fromRGBO(112, 59, 21, 1.0);
...
class _ManagementBodyDetailsPage extends State<ManagementBodyDetailsPage>{
  ...
  initState(){
    ...
    _originState = managementBodyNotifier.currentManagementBody.stateOfOrigin;
