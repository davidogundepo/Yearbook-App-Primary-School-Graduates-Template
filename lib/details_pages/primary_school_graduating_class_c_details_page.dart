...
Color shapeDecorationColor = Color.fromRGBO(5, 89, 91, 1);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(2, 52, 52, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(5, 89, 91, 1);
Color shapeDecorationIconColor = Color.fromRGBO(2, 52, 52, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(5, 89, 91, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(5, 89, 91, 1);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(2, 52, 52, 1.0);
Color buttonColor = Color.fromRGBO(5, 89, 91, 1);
Color textColor = Color.fromRGBO(5, 89, 91, 1);
...
class _SubPageState extends State<SubPage> {
  ...
  initState() {
    ...
    _stateLiving = primarySchoolGraduatingClassCNotifier.currentPrimarySchoolGraduatingClassC.stateLiving;
    _originState = primarySchoolGraduatingClassCNotifier.currentPrimarySchoolGraduatingClassC.originState;
