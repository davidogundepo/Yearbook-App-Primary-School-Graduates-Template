...
Color backgroundColor = Color.fromRGBO(136, 169, 168, 1.0);
Color appBarBackgroundColor = Color.fromRGBO(136, 169, 168, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(136, 169, 168, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(136, 169, 168, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(136, 169, 168, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(254, 255, 236, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(136, 169, 168, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(136, 169, 168, 1.0);
Color iconTextColor = Colors.white;
Color buttonColor = Color.fromRGBO(136, 169, 168, 1.0);
Color textColor = Color.fromRGBO(136, 169, 168, 1.0);
...
class _GraduatesClassTeachersDetailsPage extends State<GraduatesClassTeachersDetailsPage>{
  ...
  initState(){
    ...
    _originState = graduatesClassTeachersNotifier.currentGraduatesClassTeachers.stateOfOrigin;
